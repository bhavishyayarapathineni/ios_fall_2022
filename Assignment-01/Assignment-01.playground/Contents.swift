...
var distance1 : Double = 3.5
var distance2 : Double = 4.5
...
// We need to explicitly convert the type of x to Double
...
if a%10 == b%10
{
    print("Last digits are same")
}
else
{
    print("Last digits are not same")
}
...
var tempStr = str1
let lastChar = tempStr.remove(at: tempStr.index(before: tempStr.endIndex))
